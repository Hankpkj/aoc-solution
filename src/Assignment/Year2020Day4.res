...
//   ->Belt.Array.map(str =>
//     str->Belt.Option.mapWithDefault("", x => x)->Js.String2.replaceByRe(%re("/:[\w#]+/"), "")
//   ) // remove unuseful value not keys
//   ->Belt.Array.keep(x => x !== "") // filter empty string
//   ->Belt_SetString.fromArray // to set_string

// let judge = s => s->Belt_SetString.intersect(require)->Belt_SetString.size === 7
...
//   ->Belt.Option.flatMap(byr =>
//     str
//     ->parseYear(iyrRe, 2010, 2020)
//     ->Belt.Option.flatMap(iyr =>
//       str
//       ->parseYear(eyrRe, 2020, 2030)
//       ->Belt.Option.flatMap(eyr =>
//         str
//         ->parseHgt
//         ->Belt.Option.flatMap(hgt =>
//           str
//           ->parseStr(hclRe)
//           ->Belt.Option.flatMap(hcl =>
//             str
//             ->parseStr(eclRe)
//             ->Belt.Option.flatMap(ecl =>
//               str
//               ->parseStr(pidRe)
//               ->Belt.Option.map(pid => {
//                 byr: byr,
